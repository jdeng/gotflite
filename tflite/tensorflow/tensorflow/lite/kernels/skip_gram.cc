...
TfLiteStatus SPrepare(TfLiteContext* context, TfLiteNode* node) {
...
TfLiteStatus SEval(TfLiteContext* context, TfLiteNode* node) {
...
TfLiteRegistration* Register_SKIP_GRAM() {
  static TfLiteRegistration r = {nullptr, nullptr, SPrepare, SEval};
  return &r;
}
